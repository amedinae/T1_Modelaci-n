...
def kutta4(x,sistema,Q2=0,):
    k1 = sistema(x,Q2)
    k2 = sistema(x+1/2*k1*dt,Q2)
    k3 = sistema(x+1/2*k2*dt,Q2)
    k4 = sistema(x+k3*dt,Q2)
...
for i in range(1,it+1):
    ...
    x2[i,:] = kutta4(x2[i-1,:],dXdt,Q1-x1[i-1,1])
