...
def dXdt(x,kf,kr):
    [[kf1,kf2,kf3,kf4,kf5,kf6],[kr1,kr2,kr3,kr4,kr5,kr6]] = velocidad_reaccion(kf,kr,x[7])
    return np.array([
...
def kutta4(x,dt,kf,kr):
    k1 = dXdt(x,kf,kr)
    k2 = dXdt(x+1/2*k1*dt,kf,kr)
    k3 = dXdt(x+1/2*k2*dt,kf,kr)
    k4 = dXdt(x+k3*dt,kf,kr)
