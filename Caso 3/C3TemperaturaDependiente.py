...
def funciones(t,x,i):
    ...
    if(i==0):
        ...
        f=-(1/x[4])*(- kf2*x[2]*x[4] + kr2*x[0]*x[3] - kf3*x[3]*x[4] + kr3*x[0]*x[5] + kf5*x[0]*x[6] - kr5*x[4]*x[1])*x[7]
    return f
